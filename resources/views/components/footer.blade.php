...
<footer class="bg-[#2B1517] text-white">
    
    {{-- Kontainer Utama Footer --}}
    {{-- PERUBAHAN 1: py-16 menjadi py-12 untuk mengurangi padding vertikal --}}
...
<div class="flex items-center gap-4 pt-4">
    ...
    <a href="https://www.facebook.com/p/PT-Medlab-Nusantara-61553304283514/" 
       class="w-10 h-10 flex items-center justify-center rounded-full bg-white/10 hover:bg-[#B1252E] transition-all duration-300 group relative"
       target="_blank" rel="noopener noreferrer">
        <svg class="w-5 h-5 text-white transition-all duration-300 ease-[cubic-bezier(0.175,0.885,0.32,1.275)] group-hover:scale-125 group-hover:-translate-y-2 group-hover:drop-shadow-[0_8px_8px_rgba(0,0,0,0.5)]" 
    ...
    {{-- TikTok --}}
    <a href="https://www.tiktok.com/@ptmedlabnusantara" 
       class="w-10 h-10 flex items-center justify-center rounded-full bg-white/10 hover:bg-[#B1252E] transition-all duration-300 group relative"
       target="_blank" rel="noopener noreferrer">
        <svg class="w-5 h-5 text-white transition-all duration-300 ease-[cubic-bezier(0.175,0.885,0.32,1.275)] group-hover:scale-125 group-hover:-translate-y-2 group-hover:drop-shadow-[0_8px_8px_rgba(0,0,0,0.5)]" 
             fill="currentColor" viewBox="0 0 24 24">
    ...
    {{-- Copyright Bar --}}
    {{-- PERUBAHAN 2: mt-2 diganti menjadi mt-0 untuk menghilangkan margin atas --}}
    <div class="border-t border-white/10 mt-0 pt-6 pb-6">
