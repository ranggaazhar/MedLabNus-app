...
<section id="product-section"
    ...
    <div class="w-full px-6 lg:px-12 xl:px-20">
        ...
        <div class="max-w-[1800px] mx-auto space-y-16">
            ...
            {{-- UBAH: grid-cols-2 menjadi grid-cols-5 untuk rasio 3:2 --}}

            <div class="grid lg:grid-cols-5 gap-16 items-center reveal">

                {{-- TAMBAH: lg:col-span-3 untuk mengambil 3/5 lebar --}}
                ...
                {{-- TAMBAH: lg:col-span-2 untuk mengambil 2/5 lebar --}}
            ...
            {{-- UBAH: grid-cols-2 menjadi grid-cols-5 untuk rasio 2:3 --}}
