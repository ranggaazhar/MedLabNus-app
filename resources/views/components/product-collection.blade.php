    ...
    <div class="w-full px-6 lg:px-12 xl:px-20">
                    ...
                    <div class="flex items-center justify-center gap-4 h-full">
                        @php
                            ...
                            $carouselImages = [
                                ...
                                // Menggunakan fungsi asset() untuk mendapatkan URL publik
        ...
        <div class="max-w-[1800px] mx-auto space-y-16">
            ...
            <div class="grid lg:grid-cols-5 gap-16 items-center reveal">
                ...
                <div class="space-y-6 lg:col-span-3">
                    <div class="flex items-center gap-4">
                        <div
                            class="w-16 h-16 bg-gradient-to-br from-[#B1252E] to-[#8f1d24] rounded-2xl flex items-center justify-center shadow-lg">
                ...
                {{-- Image Section (2/5) --}}
                <div
                    class="relative overflow-hidden rounded-3xl shadow-2xl hover-scale bg-gray-100 p-8 h-[400px] flex items-center justify-center transition-transform duration-300 lg:col-span-2">
                    @if ($produks->count() > 0)
                        <img src="{{ asset('storage/' . $produks->first()->gambar_utama) }}"
                            alt="{{ $produks->first()->nama_produk ?? 'Alat Medis' }}" class="w-full h-full object-contain">
                    @else
            ...
            <div class="grid lg:grid-cols-5 gap-16 items-center reveal delay-200">
                ...
                {{-- Image Section (2/5) --}}
                <div
                    class="relative overflow-hidden rounded-3xl shadow-2xl hover-scale bg-gray-100 p-8 h-[400px] flex items-center justify-center transition-transform duration-300 order-2 lg:order-1 lg:col-span-2">
                ...
                <div class="space-y-6 order-1 lg:order-2 lg:col-span-3">
                    ...
                    <p class="text-xl leading-relaxed text-gray-600">
                        Reagen berkualitas tinggi yang memastikan hasil pengujian laboratorium yang akurat, cepat, dan
                        dapat diandalkan.
                    </p>
