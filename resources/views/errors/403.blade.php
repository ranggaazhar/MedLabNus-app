...
<head>
    ...
    <title>403 - Akses Ditolak | PT Medlab Nusantara</title>
...
<body class="w-full overflow-x-hidden bg-white flex flex-col min-h-screen" x-data="{ mobileMenuOpen: false }">
    ...
    <main class="flex-grow flex items-center justify-center relative py-24">
        ...
        <div class="relative z-10 text-center px-6 animate-fade-in-up max-w-2xl mx-auto">
            ...
            <h1 class="text-7xl md:text-9xl font-bold text-[#B1252E] mb-4 drop-shadow-md">403</h1>
            <h2 class="text-2xl md:text-4xl font-bold text-gray-800 mb-4">Akses Ditolak</h2>
            <p class="text-gray-600 mb-10 text-lg leading-relaxed">
                Maaf, Anda tidak memiliki wewenang atau hak akses untuk membuka halaman ini. Silakan hubungi administrator jika Anda merasa ini adalah kesalahan.
            </p>
