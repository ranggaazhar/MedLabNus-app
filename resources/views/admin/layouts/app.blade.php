...
<head>
    ...
    <style>
        /* --- CSS MAGIC: LAYOUT STABIL & SCROLLBAR HILANG --- */
        
        /* 1. Reset Dasar */
        html, body { 
            height: 100%; 
            margin: 0; 
            overflow: hidden; /* Scroll dimatikan di body, dipindah ke container */
        }

        /* 2. Container Scroll Utama */
        #scroll-container {
            overflow-y: scroll; /* Selalu aktifkan fungsi scroll */
            height: 100vh;      /* Tinggi penuh */
            width: 100%;
            
            /* Sembunyikan Scrollbar secara Visual (Lebar 0px) */
            scrollbar-width: none; /* Firefox */
            -ms-overflow-style: none;  /* IE/Edge */
        }

        /* Sembunyikan di Chrome/Safari */
