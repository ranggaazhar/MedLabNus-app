            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="kategori" id="kategori" required
                        ...
                        {{-- Opsi Kategori --}}
                        <option value="reagen"
                            {{ old('kategori', $produk->kategori) == 'reagen' ? 'selected' : '' }}>Reagen</option>
                        <option value="alat"
                            {{ old('kategori', $produk->kategori) == 'alat' ? 'selected' : '' }}>Alat</option>
                        <option value="steril"
                            {{ old('kategori', $produk->kategori) == 'steril' ? 'selected' : '' }}>Steril</option>
