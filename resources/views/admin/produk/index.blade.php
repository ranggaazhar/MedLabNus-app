 ...
 {{-- TOOLBAR SECTION --}}
    <div class="bg-white rounded-2xl p-4 mb-6 shadow-sm border border-gray-100 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div class="flex w-full md:w-auto gap-3">
            <form method="GET" action="{{ route('produk.index') }}" class="flex gap-3 items-center">
                ...
                <div x-data="{ open: false }" class="relative">
                    ...
                    <div x-show="open" @click.outside="open = false" x-transition
                        ...
                        <a href="{{ route('produk.index', ['kategori' => 'alat']) }}"
                            class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                            Alat
                        </a>
                        <a href="{{ route('produk.index', ['kategori' => 'reagen']) }}"
                            class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                            Reagen
                        </a>
                        {{-- Opsi Kategori Baru --}}
                        <a href="{{ route('produk.index', ['kategori' => 'steril', 'search' => request('search')]) }}"
                        ...
                        <a href="{{ route('produk.index', ['kategori' => 'non steril', 'search' => request('search')]) }}"
                        ...
                        <a href="{{ route('produk.index', ['kategori' => 'invitro', 'search' => request('search')]) }}"
