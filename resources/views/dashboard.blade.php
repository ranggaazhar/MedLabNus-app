                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="py-4 px-6">
                                <div class="flex items-center justify-center gap-3">
                                    ...
                                    <form action="{{ route('produk.destroy', $item->produk_id) }}" method="POST" class="inline delete-form">
                                        @csrf @method('DELETE')
                                        <button type="button" class="p-2 text-red-500 hover:text-red-700 transition btn-delete" title="Hapus">
                        ...
                        <tr>
                            <td colspan="5" class="py-12 text-center">
                                <div class="flex flex-col items-center gap-3">
                                    ...
                                    <a href="{{ route('produk.create') }}" class="text-red-700 hover:text-red-800 font-semibold text-sm">
