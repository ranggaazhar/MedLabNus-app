        ...
        <div class="max-w-[1800px] mx-auto">
            ...
            <div class="mb-12 animate-fade-in-up">
                <ol class="flex items-center gap-2 text-sm text-gray-500">
                    ...
                    <li>/</li>
                    <li><a href="{{ route('products.public') }}"
                            class="hover:text-[#B1252E] transition-colors">PRODUCT</a></li>
                    <li>/</li>
            ...
            <div class="bg-white rounded-3xl shadow-2xl overflow-hidden">
                <div class="grid lg:grid-cols-2 gap-0">
                    ...
                    {{-- Left: Product Image --}}
                    <div
                        class="bg-gradient-to-br from-gray-50 to-white p-8 lg:p-16 flex items-center justify-center animate-fade-in-left delay-200">
                        <div class="w-full max-w-xl">
                            <div class="image-zoom-container rounded-2xl bg-white shadow-lg p-8">
                                <img :src="currentImage" alt="{{ $produk->nama_produk }}"
                                    class="w-full h-auto object-contain max-h-[500px]" x-transition />
                            </div>
                    ...
                    <div class="p-8 lg:p-16 flex flex-col justify-center animate-fade-in-right delay-300">
                        ...
                        <div class="flex items-center gap-3 mb-8">
                            ...
                            @else
                                <div
                                    class="w-12 h-12 bg-gradient-to-br from-[#B1252E] to-[#8f1d24] rounded-xl flex items-center justify-center shadow-lg">
                        ...
                        <div class="inline-block mb-6 animate-scale-in delay-400">
                            <span
                                class="px-4 py-2 bg-[#B1252E]/10 text-[#B1252E] rounded-full text-sm font-semibold uppercase tracking-wider">
                        ...
                        @php
                            ...
                            $cleanPhone = preg_replace('/[^0-9]/', '', $nomorTujuan);

                            // 2. Pesan otomatis
                            $pesanWA = "Halo Admin, saya sedang melihat produk di website Anda.\n\n" .
                        ...
                        @foreach($relatedProducts as $related)
                            <a href="{{ route('products.show', $related->produk_id) }}"
                                ...
                                <div class="px-5 pb-6 pt-4">
                                    <p class="text-sm text-gray-500 mb-1 font-medium uppercase tracking-wider">
                                        {{ $related->pabrikan->nama_pabrikan ?? 'Unknown Brand' }}
                                    </p>
                                    <h3
                                        class="font-bold text-lg text-gray-900 leading-tight group-hover:text-[#B1252E] transition-colors duration-300 line-clamp-2">
                                        {{ $related->nama_produk }}
                                    </h3>
                                </div>
                            </a>
